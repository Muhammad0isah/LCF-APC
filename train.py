...
from model.lcf_apc import LCF_ATEPC
...
def main(config):
    ...
    def evaluate(eval_APC=True):
        ...
        for input_ids_spc, input_mask, segment_ids, label_ids, polarities, valid_ids, l_mask in eval_dataloader:
            ...
            with torch.no_grad():
                apc_logits = model(input_ids_spc, segment_ids, input_mask,
    ...
    def train():
        ...
        for epoch in range(int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                loss_apc = model(input_ids_spc, segment_ids, input_mask, label_ids, polarities, valid_ids,
                                           l_mask)
                loss = loss_apc
                loss.backward()
...
if __name__ == "__main__":
    ...
    for config in exp_configs:
        ...
        for i in range(n):
            ...
            logger.info('max_apc_test_acc: {} \t max_apc_test_f1: {} \t'
